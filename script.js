...
const cartItemsContainder = document.getElementById("cart-items")
...
function updateCartModal() {
    ...
    cart.forEach(item => {
        ...
        cartItemsContainder.appendChild(cartItemElement)
    })
...
cartItemsContainder.addEventListener("click", function (event) {
